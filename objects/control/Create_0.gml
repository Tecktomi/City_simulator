...
#region edificios
	...
	#region definición
		...
		def_edificio_base("Escuela", 3, 3, 800, 640, [1, 10, 26], [30, 5, 25], 6, 40); def_edificio_servicio(,,,true, 2, 20, 60); def_edificio_trabajo(true, 4, 50, 8, 2)
		...
		def_edificio_base("Escuela parroquial", 4, 3, 1300, 720, [1, 10, 26], [20, 5, 30], 12, 45); def_edificio_servicio(,, true, true, 1, 10, 35); def_edificio_trabajo(true, 5, 60, 6, 2)
		...
		def_edificio_base("Taller de Destilado", 5, 4, 3500, 900, [1, 10, 24, 26], [25, 10, 25, 40], 20, 40, 5, false); def_edificio_servicio(); def_edificio_trabajo(true, 12, 40, 5,, 0.01, true, [5], [3], [22], [1], 1)
		...
		def_edificio_base("Pozo Petrolífero", 4, 4, 3000, 730, [10, 15, 26], [30, 30, 30], 20, 20, -20, false,,,,,,,,, 60); def_edificio_servicio(); def_edificio_trabajo(true, 4, 30, 5, 1, 0.03)
	#endregion
