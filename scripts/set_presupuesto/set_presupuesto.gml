function set_presupuesto(presupuesto, edificio = control.null_edificio){
	...
	with control{
		if edificio_es_trabajo[index]{
			edificio.trabajo_calidad -= edificio_trabajo_calidad[index] + 3 * (edificio.presupuesto - 2)
			edificio.trabajo_sueldo -= max(sueldo_minimo, edificio_trabajo_sueldo[index] + edificio.presupuesto - 2)
			edificio.trabajo_riesgo -= edificio_trabajo_riesgo[index] * power(2, 3 - edificio.presupuesto)
		}
